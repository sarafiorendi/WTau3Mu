...
events = Events([
    '/afs/cern.ch/work/m/manzoni/tauHLT/2017/CMSSW_9_2_4/src/HLTrigger/Configuration/test/tau3mu/outputFULL_Iter0and1_v3.root',
#     '/afs/cern.ch/work/m/manzoni/tauHLT/2017/CMSSW_9_2_4/src/HLTrigger/Configuration/test/tau3mu/outputFULL_Iter0and1_v2.root',
#     '/afs/cern.ch/work/m/manzoni/tauHLT/2017/CMSSW_9_2_4/src/HLTrigger/Configuration/test/tau3mu/outputFULL_Iter0and1.root',
#     '/afs/cern.ch/work/m/manzoni/tauHLT/2017/CMSSW_9_2_4/src/HLTrigger/Configuration/test/tau3mu/outputFULL_Iter2.root',
#     '/afs/cern.ch/work/m/manzoni/tauHLT/2017/CMSSW_9_2_4/src/HLTrigger/Configuration/test/tau3mu/outputFULL_Iter0.root',
#     '/afs/cern.ch/work/m/manzoni/tauHLT/2017/CMSSW_9_2_4/src/HLTrigger/Configuration/test/tau3mu/outputFULL.root',
#     '/afs/cern.ch/work/m/manzoni/tauHLT/2017/CMSSW_9_2_4/src/HLTrigger/Configuration/test/tau3mu/outputFULL_manySeeds.root',
#     'outputFULL_manySeeds.root',
])
...
f1 = ROOT.TFile('tau3mu_tuple.root', 'recreate')
...
#     muons = [mu for mu in muons if mu.isMediumMuon() and abs(mu.eta())<2.5 and mu.pt()>1.]
    muons = [mu for mu in muons if mu.isSoftMuon(vertices[0]) and abs(mu.eta())<2.5 and mu.pt()>1.]
