...
## manual blind sara
# selected_tree = data_tree.CopyTree('(' + args.selection + ') & ((cand_refit_tau_mass>1.61 & cand_refit_tau_mass < 1.72 ) | (cand_refit_tau_mass > 1.84 & cand_refit_tau_mass<1.99))')
...
w.factory('Polynomial::bkg_pol1(mass,b0%s[-0.1, -100,100])'    %args.category)
w.factory('RooPolynomial::bkg_pol2(mass,{c0%s[0.1, -100,100],c1%s[0.1, -100,100]})' %(args.category,args.category))
...
shapes background    Wtau3mu{cat}       background_pdfs.root backgrounds:roomultipdf
--------------------------------------------------------------------------------
bin               Wtau3mu{cat}
observation       -1
--------------------------------------------------------------------------------
